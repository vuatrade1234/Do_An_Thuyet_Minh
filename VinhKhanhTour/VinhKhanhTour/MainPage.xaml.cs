...
public partial class MainPage : ContentPage
{
    ...
    {
        // Đổi tên file DB sang V26 để cập nhật đủ 10 quán mới
        var dbPath = Path.Combine(FileSystem.AppDataDirectory, "VinhKhanh_V26.db3");
        ...
        if (await _db.Table<POI>().CountAsync() == 0)
        {
            var data = new List<POI> {
                new POI { Id="1", TenQuan="Ốc Oanh", Latitude=10.7602, Longitude=106.7042, BanKinh=30, Menu="Ốc hương rang muối, sò lông nướng.", ThuyetMinhVi="Chào mừng bạn đến với Ốc Oanh." },
                new POI { Id="2", TenQuan="Vịt Phát Thành", Latitude=10.7615, Longitude=106.7051, BanKinh=30, Menu="Vịt quay Bắc Kinh, xá xíu.", ThuyetMinhVi="Bạn đang ở Vịt Phát Thành." },
                new POI { Id="3", TenQuan="Sushi Ko", Latitude=10.7608, Longitude=106.7045, BanKinh=30, Menu="Sashimi cá hồi, cơm cuộn.", ThuyetMinhVi="Sushi Ko mang đến hương vị Nhật Bản." },
                new POI { Id="4", TenQuan="Ốc Đào", Latitude=10.7621, Longitude=106.7058, BanKinh=30, Menu="Ốc tỏi nướng, nghêu hấp sả.", ThuyetMinhVi="Bạn đã đến khu vực Ốc Đào." },
                new POI { Id="5", TenQuan="Lẩu Bò Khu Nhà Cháy", Latitude=10.7595, Longitude=106.7038, BanKinh=30, Menu="Lẩu bò thập cẩm, vú nướng.", ThuyetMinhVi="Thưởng thức lẩu bò tại Khu Nhà Cháy." },
                new POI { Id="6", TenQuan="Phá Lấu Cô Thảo", Latitude=10.7628, Longitude=106.7062, BanKinh=30, Menu="Phá lấu bò, bánh mì.", ThuyetMinhVi="Phá lấu Cô Thảo nổi tiếng Quận 4." },
                new POI { Id="7", TenQuan="Bún Cá Châu Đốc", Latitude=10.7635, Longitude=106.7068, BanKinh=30, Menu="Bún cá miền Tây.", ThuyetMinhVi="Hương vị bún cá Châu Đốc đặc trưng." },
                new POI { Id="8", TenQuan="Chè Hà Trâm", Latitude=10.7612, Longitude=106.7049, BanKinh=30, Menu="Chè thái, khúc bạch.", ThuyetMinhVi="Giải nhiệt tại tiệm chè Hà Trâm." },
                new POI { Id="9", TenQuan="Mì Gia Tân Tòng Lợi", Latitude=10.7618, Longitude=106.7055, BanKinh=30, Menu="Mì vịt tiềm, sủi cảo.", ThuyetMinhVi="Mì gia truyền thống Tân Tòng Lợi." },
                new POI { Id="10", TenQuan="Bánh Tráng Chú Viên", Latitude=10.7625, Longitude=106.7060, BanKinh=30, Menu="Bánh tráng trộn thập cẩm.", ThuyetMinhVi="Thưởng thức bánh tráng trộn chú Viên." }
            };
